...
if(('users',) in tables):
    ...
    try:
        conn.execute('CREATE TABLE users (username TEXT, firstname TEXT, lastname TEXT, phoneno TEXT, emailid TEXT, password TEXT, country TEXT, interests TEXT), requested TEXT')
        conn.commit()
